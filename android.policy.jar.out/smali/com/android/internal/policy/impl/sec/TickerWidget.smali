...
.method public constructor <init>(Landroid/content/Context;Landroid/content/res/Configuration;Lcom/android/internal/policy/impl/KeyguardScreenCallback;Lcom/android/internal/policy/impl/sec/CircleUnlockWidget;Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;)V
    ...
    .line 290
    const v2, #android:layout@keyguard_circlelock_tickerwidget#t

    invoke-virtual {v1, v2, p0, v4}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;Z)Landroid/view/View;

    .line 294
    :goto_1
    const v2, #android:id@ticker_sliding_drawer#t
    ...
    .line 295
    const v2, #android:id@ticker_horizontal_scroll_view#t
    ...
    .line 296
    const v2, #android:id@ticker_sliding_content#t
    ...
    .line 298
    const v2, #android:id@ticker_sliding_handle_logo#t
    ...
    .line 299
    const v2, #android:id@ticker_sliding_handle_arrow#t
    ...
    .line 300
    const v2, #android:id@ticker_sliding_handle_refresh_image#t
    ...
    const v4, #android:string@lockscreen_ticker_refresh_tts#t
    ...
    .line 302
    const v2, #android:id@ticker_sliding_handle_refresh_progress#t
    ...
    .line 303
    const v2, #android:id@ticker_sliding_handle_update_date#t
    ...
    :cond_3
    const v2, #android:layout@keyguard_circlelock_tickerwidget_land#t
...
.method private UpdateData(Lcom/android/internal/policy/impl/sec/TickerUtil$TickerStatus;)V
    ...
    .prologue
    const v11, #android:string@lockscreen_ticker_no_data_to_display#t
    ...
    const v10, #android:string@lockscreen_ticker_country_failed#t
    ...
    const v10, #android:string@lockscreen_ticker_stock_no_time#t
    ...
    const v10, #android:string@lockscreen_ticker_fb_long_in#t
    ...
    const v10, #android:string@lockscreen_ticker_fb_application_install#t
    ...
    const v10, #android:string@lockscreen_ticker_newtork_unavailable#t
    ...
    const v10, #android:string@lockscreen_ticker_newtork_unavailable_fb#t
...
.method private showFacebookRefreshFailed()V
    ...
    const v3, #android:string@lockscreen_ticker_connection_failed#t
...
.method private updateFacebookData()V
    ...
    const v3, #android:drawable@keyguard_ticker_stock_ic_facebook#t
    ...
    const v4, #android:string@lockscreen_ticker_logo_facebook_tts#t
...
.method private updateNewsData()V
    ...
    const v2, #android:drawable@keyguard_ticker_news_ic_yeonhapnews#t
    ...
    const v3, #android:string@lockscreen_ticker_logo_news_tts#t
    ...
    const v2, #android:drawable@keyguard_ticker_news_ic_sina#t
    ...
    const v2, #android:drawable@keyguard_ticker_news_ic_camobile#t
    ...
    const v2, #android:drawable@keyguard_ticker_news_ic_yahoo#t
...
.method private updateSinaweiboData()V
    ...
    const v2, #android:drawable@keyguard_ticker_sns_ic_sinaweibo#t
...
.method private updateStockData()V
    ...
    const v2, #android:drawable@keyguard_ticker_stock_ic_edaily#t
    ...
    const v3, #android:string@lockscreen_ticker_logo_stock_tts#t
    ...
    const v2, #android:drawable@keyguard_ticker_stock_ic_sina#t
    ...
    const v2, #android:drawable@keyguard_ticker_stock_ic_yahoo2#t
