...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/policy/impl/sec/CircleUnlockWidget;Lcom/android/internal/policy/impl/KeyguardScreenCallback;Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;)V
    ...
    :cond_0
    :goto_1
    const v4, #android:id@missed_event_call_image#t
    ...
    .line 210
    const v4, #android:id@missed_event_msg_image#t
    ...
    .line 211
    const v4, #android:id@missed_event_vvm_image#t
    ...
    .line 215
    const v4, #android:id@missed_event_call_background_layout#t
    ...
    .line 216
    const v4, #android:id@missed_event_msg_background_layout#t
    ...
    .line 217
    const v4, #android:id@missed_event_vvm_background_layout#t
    ...
    .line 224
    const v4, #android:id@missed_event_call_layout#t
    ...
    .line 225
    const v4, #android:id@missed_event_msg_layout#t
    ...
    .line 226
    const v4, #android:id@missed_event_vvm_layout#t
    ...
    .line 234
    const v4, #android:id@missed_event_call_text#t
    ...
    .line 235
    const v4, #android:id@missed_event_msg_text#t
    ...
    .line 236
    const v4, #android:id@missed_event_vvm_text#t
    ...
    .line 237
    const v4, #android:id@help_text_for_waterlock#t
    ...
    .line 181
    const v4, #android:layout@keyguard_circlelock_missed_event_da_land#t
...
.method public getTTSMessage()Ljava/lang/String;
    ...
    const v2, #android:string@zzz_tts_lockscreen_calls_and_messages#t
    ...
    const v2, #android:string@zzz_tts_lockscreen_n_missed_calls#t
    ...
    const v2, #android:string@zzz_tts_lockscreen_n_unread_messages#t
    ...
    const v2, #android:string@zzz_tts_lockscreen_1_missed_call#t
    ...
    const v2, #android:string@zzz_tts_lockscreen_1_unread_message#t
    ...
    const v2, #android:string@zzz_tts_lockscreen_no_missed_event#t
...
.method public getTTSMessage(Z)Ljava/lang/String;
    ...
    .prologue
    const v5, #android:string@zzz_tts_lockscreen_1_missed_call#t
    ...
    const v4, #android:string@zzz_tts_lockscreen_missed_swipe#t
    ...
    const v5, #android:string@zzz_tts_lockscreen_n_missed_calls#t
    ...
    const v4, #android:string@zzz_tts_lockscreen_missed_swipe_touch_exploration#t
    ...
    const v5, #android:string@zzz_tts_lockscreen_n_unread_messages#t
