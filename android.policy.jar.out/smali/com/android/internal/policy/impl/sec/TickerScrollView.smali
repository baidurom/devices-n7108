...
.method private createMessage(Landroid/content/Context;Ljava/lang/String;)Landroid/widget/FrameLayout;
    ...
    const v4, #android:layout@keyguard_circlelock_tickerwidget_news_error#t
    ...
    .line 218
    const v4, #android:id@ticker_news_error_message#t
    ...
    .line 220
    const v4, #android:id@ticker_news_error_button#t
...
.method private createMessage(Landroid/content/Context;Ljava/lang/String;Lcom/android/internal/policy/impl/sec/TickerUtil$TickerStatus;)Landroid/widget/FrameLayout;
    ...
    .line 233
    :pswitch_0
    const v4, #android:string@lockscreen_ticker_news_settings#t
    ...
    .line 264
    :pswitch_1
    const v4, #android:string@lockscreen_ticker_stock_settings#t
    ...
    .line 297
    :pswitch_2
    const v4, #android:string@lockscreen_ticker_fb_button#t
    ...
    .line 313
    :pswitch_3
    const v4, #android:string@lockscreen_ticker_fb_install#t
    ...
    .line 326
    :pswitch_4
    const v4, #android:string@lockscreen_ticker_wifi_settings#t
...
.method initFacebookData(Landroid/content/Context;Ljava/util/ArrayList;)V
    ...
    const v7, #android:layout@keyguard_circlelock_tickerwidget_facebook_vertical#t
...
.method initNewsData(Landroid/content/Context;Ljava/util/ArrayList;)V
    ...
    const v7, #android:layout@keyguard_circlelock_tickerwidget_news_vertical#t
...
.method initStockData(Landroid/content/Context;Ljava/util/ArrayList;)V
    ...
    const v9, #android:layout@keyguard_circlelock_tickerwidget_stock_vertical#t
