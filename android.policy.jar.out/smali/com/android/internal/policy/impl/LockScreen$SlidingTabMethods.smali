...
.method public onGrabbedStateChange(Landroid/view/View;I)V
    ...
    const v0, #android:string@lockscreen_sound_on_label#t
    ...
    .line 174
    :cond_2
    const v0, #android:string@lockscreen_sound_off_label#t
...
.method public updateResources()V
    ...
    const v1, #android:drawable@ic_jog_dial_vibrate_on#t
    ...
    const v2, #android:drawable@jog_tab_target_yellow#t
    ...
    const v3, #android:drawable@jog_tab_bar_right_sound_on#t
    ...
    const v4, #android:drawable@jog_tab_right_sound_on#t
    ...
    :cond_1
    const v1, #android:drawable@ic_jog_dial_sound_off#t

    goto :goto_1

    :cond_2
    const v1, #android:drawable@ic_jog_dial_sound_on#t

    goto :goto_1

    :cond_3
    const v2, #android:drawable@jog_tab_target_gray#t

    goto :goto_2

    :cond_4
    const v3, #android:drawable@jog_tab_bar_right_sound_off#t

    goto :goto_3

    :cond_5
    const v4, #android:drawable@jog_tab_right_sound_off#t
