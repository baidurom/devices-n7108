...
.method constructor <init>(Landroid/content/Context;Landroid/content/res/Configuration;Lcom/android/internal/widget/LockPatternUtils;Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;Lcom/android/internal/policy/impl/KeyguardScreenCallback;)V
    ...
    .line 460
    const v0, #android:layout@keyguard_screen_tab_unlock#t
    ...
    .line 476
    const v0, #android:id@unlock_widget#t
    ...
    :cond_0
    const v0, #android:layout@keyguard_screen_tab_unlock_land#t
...
.method private createUnlockMethods(Landroid/view/View;)Lcom/android/internal/policy/impl/LockScreen$UnlockWidgetCommonMethods;
    ...
    .line 487
    const v6, #android:string@lockscreen_unlock_label#t

    invoke-virtual {v3, v6}, Lcom/android/internal/widget/SlidingTab;->setLeftHintText(I)V

    .line 488
    const v6, #android:drawable@ic_jog_dial_unlock#t

    const v7, #android:drawable@jog_tab_target_green#t

    const v8, #android:drawable@jog_tab_bar_left_unlock#t

    const v9, #android:drawable@jog_tab_left_unlock#t
...
.method private updateTargets()V
    ...
    const v8, #android:drawable@ic_lockscreen_camera#t
    ...
    const v8, #android:drawable@ic_action_assist_generic#t
