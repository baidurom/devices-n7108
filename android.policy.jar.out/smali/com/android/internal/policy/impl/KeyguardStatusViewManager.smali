...
# static fields
.field public static final ALARM_ICON:I = #android:drawable@ic_lock_idle_alarm#t
...
.method public constructor <init>(Landroid/view/View;Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;Lcom/android/internal/widget/LockPatternUtils;Lcom/android/internal/policy/impl/KeyguardScreenCallback;Z)V
    ...
    .line 215
    const v6, #android:id@unlockscreen_root#t
    ...
    .line 217
    const v6, #android:id@emergencyCallText#t
    ...
    .line 242
    const v6, #android:id@alarm_status#t
    ...
    .line 243
    const v6, #android:id@propertyOf#t
    ...
    .line 244
    const v6, #android:id@transport#t
    ...
    .line 245
    const v6, #android:id@emergencyCallButton#t
    ...
    .line 250
    const v6, #android:id@secure_clock#t
    ...
    const v7, #android:string@lockscreen_emergency_call#t
...
.method private getAltTextMessage(Llibcore/util/MutableInt;)Ljava/lang/CharSequence;
    ...
    const v2, #android:string@lockscreen_charged#t
    ...
    const v2, #android:string@lockscreen_plugged_in#t
...
.method private updateAlarmInfo()V
    ...
    const v4, #android:drawable@ic_lock_idle_alarm#t
...
.method private updateCarrierStateWithSimStatus(Lcom/android/internal/telephony/IccCard$State;)V
    ...
    .prologue
    const v5, #android:string@lockscreen_missing_sim_message_short#t
    ...
    const v3, #android:string@lockscreen_permanent_disabled_sim_message_short#t
