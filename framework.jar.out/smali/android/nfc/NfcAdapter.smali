...
.method public activeSwp()V
    ...
    .prologue
    .line 1600
    invoke-virtual {p0}, Landroid/nfc/NfcAdapter;->selectUicc()V
...
.method public deSelectedSecureElement()V
    ...
    invoke-interface {v1}, Landroid/nfc/INfcAdapter;->deselectAllSecureElement()I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v2, "deselectAllSecureElement failed"
...
.method public deselectAllSecureElement()I
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {v2}, Landroid/nfc/INfcAdapter;->deselectAllSecureElement()I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Deselect ALL SE!!"
    ...
    const-string v3, "Deselect All SE failed"
...
.method public selectDefaultSecureElement(Ljava/lang/String;)V
    ...
    const-string v6, "UICC_ID in selectDefaultSecureElement"
    ...
    invoke-interface {v5}, Landroid/nfc/INfcAdapter;->deselectAllSecureElement()I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v6, "SMART_MX_ID in selectDefaultSecureElement"
    ...
    invoke-interface {v5, v2, v6}, Landroid/nfc/INfcAdapter;->storeSePreference(IZ)V
...
.method public setDefaultSecureElementState(Z)V
    ...
    const-string/jumbo v3, "setSecureElementState ----- Enable card emulation"
    ...
    const-string/jumbo v3, "setSecureElementState ----- Disable card emulation"
